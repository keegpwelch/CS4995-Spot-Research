...
"""
Contains code from Boston Dynamics's SDK
and from Ryan Orf and David Hannan at University of Missouri,
worked in collaboration on Gesture Control project
"""
...
def main(argv):
    ...
    parser.add_argument('--save-path', default=None, nargs='?',
